			...
			for i = 1, #spots do
				...
				if (px and pz and metal) then
					...
					if (not features or #features == 0) then
						...
						if (metal > 2.7) then
							metalIdx = 3
						elseif (metal >=  2.35 and metal <=2.45) then
							metalIdx = "2b"
						...
						local fId = Spring.CreateFeature("map_metal_spot"..metalIdx,pxFixed,spGetGroundHeight(pxFixed,pzFixed),pzFixed,math.random(360),gaiaTeamId)
